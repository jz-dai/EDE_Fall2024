...
lake_chem <- here('Data','Raw','NTL-LTER_Lake_ChemistryPhysics_Raw.csv')
print(lake_chem)

file.exists(lake_chem)

lake_chem_data <- read.csv(
  file = lake_chem,
  stringsAsFactors = T
)
...
sites$dow <- factor(sites$dow, levels=c("1","2","3","4","5","6","7")) 
#Or... as.character(seq(1,7))
