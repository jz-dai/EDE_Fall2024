...
- The second column should have the header `Value` and include the metadata values: `EPAair_O3_PM25_NC1819_`  
`Processed.csv`, `2018-2019`, and `EPA Air Quality System (AQS)`.
...
```{r Month conversion, include=FALSE}
...
```{r Ozone 2018, echo=FALSE, fig.cap= "2018 monthly Ozone levels", fig.align='left', fig.height=3.8, warning=FALSE}
#Separating data from 2018 and 2019
epa_2018 <- filter(epa_data, Year == 2018)
epa_2019 <- filter(epa_data, Year == 2019)

#Plotting the graph for 2018
ozone2018 <-
  ggplot(epa_2018) +
...
```{r Ozone 2019, echo=FALSE, fig.cap= "2019 monthly Ozone levels", fig.align='left', fig.height=3.8, warning=FALSE}
#Plotting the graph for 2019
ozone2019 <-
  ggplot(epa_2019) +
  geom_boxplot(aes(x = Month, y = Ozone)) +
...
Main repository:
https://github.com/ENV872/EDE_Fall2024

Forked repository:
https://github.com/jz-dai/EDE_Fall2024